<template>
	<view class="content">
			...
			<FB-RC style="width:400px;height:640px;" ref="fb" APPID="32d7578118f045afbcac42710793112a" :UserID="userId" :RC_APP_KEY="RC_APP_KEY" :RC_APP_SECRET = "RC_APP_SECRET" :RC_TOKEN="token"></FB-RC>
			<!-- <UniFBCamera style="width:400px;height:640px;" APPID="32d7578118f045afbcac42710793112a" ref="camera"></UniFBCamera> -->
			<!-- <FB-RCCallKit style="width:200px;height:640px;" ref="fb" APPID="32d7578118f045afbcac42710793112a" :UserID="userId" :RC_APP_KEY="RC_APP_KEY" :RC_APP_SECRET = "RC_APP_SECRET" :RC_TOKEN="token"></FB-RCCallKit> -->
		<!-- <UniFBCamera style="width:480px;height:640px;" ref="fb" APPID="32d7578118f045afbcac42710793112a"></UniFBCamera> -->
		...
		<view style="display: flex;flex-direction:column;justify-content: space-evenly; position: absolute;top: 500rpx;z-index: 9;">
			...
			<view style="display: flex;flex-direction: row;">
				...
				<!-- <button @click="initAppId">initAPPID</button>
				 <button @click="zhaiFace">窄脸100</button>
				 <button @click="zhaiFace0">000</button> -->
	...
	export default {
		data() {
			return {
				...
				isShowFilter:false,
				userId:6,
				RC_APP_KEY:"cpj2xarlciggn",//APP_KEY
				RC_APP_SECRET:"qOKbPUvQeLT1c",//融云APP_SECRET
				token:"yuB19JpCWJCppRPxk0hafrqxVuPjwG7I@5plu.cn.rongnav.com;5plu.cn.rongcfg.com"
		...
		methods: {
			zhaiFace(){
				this.$refs.camera.setReshape(22,100)
			},
			zhaiFace0(){
				this.$refs.camera.setReshape(22,0)
			},
			initAppId(){
			/* 	this.$refs.fb.initStatus((res)=>{
					console.log("FB-RC===="+res.data);
					console.log("FB-RC===="+res.message);
				}) */
			},
			stopCamera(){
